def longestCommonSubsequence(str1, str2):
    #  [None if current letter not used or the letter , len of lcs, prevIidx, prevJidx ]
...
# Complexity - Time & Space O(n*m*min(n, m))
# Because we perform n * m comparisons, but concatenation step adds additional complexity
# def longestCommonSubsequence(str1, str2):
